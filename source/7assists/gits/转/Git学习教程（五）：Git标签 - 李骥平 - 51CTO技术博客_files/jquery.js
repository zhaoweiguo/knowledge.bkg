 ...
 */
	...
	this.layer = {'width' : 390, 'height': 206};//200 100
...
//            jQuery("#message").remove();
	...
	this.original = function(){	
		...
		this.layer = {'width' : 390, 'height': 206};
...
jQuery(window).scroll( function() {
	...
	var topHeight = height + document.documentElement.clientHeight - this.layer.height;
	//alert(document.documentElement.clientHeight);//document.body.scrollTop document.documentElement.scrollTop
